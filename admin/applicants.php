...
<body>
	<?php  
	  ...
	  include 'header.php';
	?>
	<div style="background-color: whitesmoke; width:1200px;height: 1000px;margin-left: 200px;"> 
			...
			<?php 
              ...
              echo "<table class='table  table-striped table-bordered' '/>";
                      ...
                      while($row=mysqli_fetch_assoc($res))
                      {
                        ...
                        echo "<td>". "<a href='my-details.php?id=".$row['id']."' class='btn btn-success'> Qualification-details</a>"."</td>"; 
