    ...
    <div class='container' style="background-color: white">
        ...
        <form method="post">
            ...
            <td><input type="text"  name="un" placeholder="University Name" required id='inputTextBox2'></td>
                ...
                <tr>
                    <td> <label> Percentage % <span class='must'>* </span></label> </td>
                    <td><input type="text" name="per_pg" placeholder="%" required id='Number' minlength="2"
                            maxlength="3"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><textarea name="other" class='ta'
                            placeholder="Other higher Qualification/Diploma Please Write in detail "
                            style="height: 100px;" required></textarea> </td>
            ...
            <input type="submit" class='bt_sb' name="btn_sbmt" value="Submit" id='submit_address'
...
<script>
function Validate() {
    var in = document.getElementById("grad");
    if ( in .value == "") {
        //If the "Please Select" option is selected display error.
        alert("Please select bacholors Degree!");
        return false;
    }
    var in = document.getElementById("pg");
    if ( in .value == "") {
        //If the "Please Select" option is selected display error.
        alert("Please select masters Degree!");
        return false;
    }
    var in = document.getElementById("cl");
    if ( in .value == "") {
        //If the "Please Select" option is selected display error.
